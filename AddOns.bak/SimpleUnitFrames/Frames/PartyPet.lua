...
SUF.options.args.partypet.args.display = {
	type = 'toggle',
	name = L["Display Frames"],
	desc = L["Display PartyPet Frames"],
	get = function(info) return GetCVarBool("showPartyPets") end,
	set = function(info, val)
		SetCVar("showPartyPets", val and "1" or "0")
	end,
	order = 1,
}
