...
if TO then
	-- There's nothing good we can hook for this frame, we have to poll refresh
	C_Timer.NewTicker(0.1, function() if UnitExists("targettarget") then TO:RefreshFontStrings("targettarget") end end)
