...
function ChatBar_UpdateButtonArt(buttonIndex, artDir)
	_G["ChatBarFrameButton"..buttonIndex.."UpTex_Spec"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_Up_Spec");
	_G["ChatBarFrameButton"..buttonIndex.."DownTex_Spec"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_Down_Spec");
	_G["ChatBarFrameButton"..buttonIndex.."Flash"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_Glow_Alpha");
	
	_G["ChatBarFrameButton"..buttonIndex.."Center"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_Center");
	_G["ChatBarFrameButton"..buttonIndex.."Background"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_BG");
	
	_G["ChatBarFrameButton"..buttonIndex.."UpTex_Shad"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_Up_Shad");
	_G["ChatBarFrameButton"..buttonIndex.."DownTex_Shad"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_Down_Shad");
	_G["ChatBarFrameButton"..buttonIndex.."Highlight"]:SetTexture("Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChanButton_Glow_Alpha");
end
...
function ChatBar_UpdateArt()
	...
	ChatBarFrameBackground:SetBackdrop({
		edgeFile = "Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\ChatBarBorder";
		bgFile = "Interface\\AddOns\\ChatBar Classic\\"..artDir.."\\BlackBg";
