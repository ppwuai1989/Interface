...
L["Icons"] = "图标"
L["If checked, coordinates will be shown."] = "勾选后，启用坐标模块。"
L["If checked, dungeon and raid locations will be shown."] = "勾选后，将显示地下城和团队副本入口。"
L["If checked, flight points will be shown."] = "勾选后，将显示各地的飞行点。"
...
L["If checked, zone and dungeon levels will be shown."] = "勾选后，显示地图和副本的建议等级。"
...
L["If checked, dungeon and raid locations will be shown."] = "勾選後，將會顯示團隊副本與地下城位置。"
L["If checked, flight points will be shown."] = "勾選後，將會顯示飛行鳥點。"
