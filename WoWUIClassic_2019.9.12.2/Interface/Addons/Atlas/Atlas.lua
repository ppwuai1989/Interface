...
function Atlas_PopulateDropdowns(self)
	local i = 1;
...
function Atlas_ToggleLock(self)
...
function Atlas_UpdateLock(self)
	if(AtlasOptions.AtlasLocked) then
...
function AtlasSwitchDD_OnLoad(self)
	local info, i;
...
function AtlasFrameDropDownType_Initialize(self)
...
function AtlasFrameDropDownType_OnShow(self)
...
function AtlasFrameDropDown_Initialize(self)
...
function AtlasFrameDropDown_OnShow(self)
	UIDropDownMenu_Initialize(AtlasFrameDropDown, AtlasFrameDropDown_Initialize, self);
