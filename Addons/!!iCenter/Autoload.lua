local function LoadAddons()
	...
	if (class == "HUNTER") then
		...
		local _, _, _, _, loadable = GetAddOnInfo("GFW_FeedOmatic_classic");
		if (loadable == "DEMAND_LOADED") and (not IsAddOnLoaded("GFW_FeedOmatic_classic")) then
			LoadAddOn("GFW_FeedOmatic_classic");
		end
